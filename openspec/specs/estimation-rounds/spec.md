...
No other deck is currently defined. A deck selection mechanism, room settings, and any second deck
are explicitly not part of the product yet, and adding one is a change to be requested rather than
assumed.
